...
?>
 ...
 ?>
  ...
  <div class="row">
     <form method="post" action="<?php echo site_url('exam/update_exam/'.$quiz['quid']);?>">
...
<br> 
 <div class="login-panel panel panel-default">
		...
		<?php if($quiz['with_login']==0){ ?>
					...
					<input type="text"  onClick="this.select()" value="<?php echo site_url('exam/exam_detail/'.$quiz['quid'].'/'.urlencode($quiz['quiz_name'])); ?>" class="form-control"  >
			</div>
...
?>
 ...
 ?>
 <a href="<?php echo site_url('exam/add_question/'.$quiz['quid']);?>" class="btn btn-danger"  ><?php echo $this->lang->line('add_question_into_quiz');?></a>
<?php
 }else{
...
?>
<a class="btn btn-success"  href="<?php echo site_url('exam');?>"><?php echo $this->lang->line('back');?></a>
<?php }else{ ?>
