 ...
 <h3><?php echo $title;?></h3>
  ...
  <div class="row">
     <form method="post" id="quiz_detail" action="<?php echo site_url('exam/validate_exam/'.$quiz['quid']);?>">
...
<tr><td>Exam Name</td><td><?php echo $quiz['quiz_name'];?></td></tr>
...
?>	
 ...
 <?php 
	...
	<button class="btn btn-success" type="submit">Start Exam</button>
 &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo site_url('quiz/open_exam/0');?>" ><?php echo $this->lang->line('back');?></a>
...
&nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo site_url('exam/open_exam/0');?>" ><?php echo $this->lang->line('back');?></a>
<?php
	} 
}
?>
