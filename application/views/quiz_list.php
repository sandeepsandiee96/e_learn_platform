...
$logged_in=$this->session->userdata('logged_in');
 ...
 <h3><?php echo $title;?></h3>
    <?php 
	$list_view="table";
	     $acp=explode(',',$logged_in['exam']);
			if(in_array('List_all',$acp)){
		?>
		<div class="row">
 
  <div class="col-lg-6">
    <form method="post" action="<?php echo site_url('exam/index/0/'.$list_view);?>">
...
<div class="card mb-4">
 ...
 <a href="<?php echo site_url('exam/index/'.$limit.'/table/active');?>"> <?php echo $this->lang->line('active');?>      
...
<div class="card mb-4">
 ...
 <a href="<?php echo site_url('exam/index/'.$limit.'/table/upcoming');?>">   <?php echo $this->lang->line('upcoming');?>     
 <?php echo $this->lang->line('quiz');?>     
</a>
</div>
<div class="card-body"  >
...
<div class="card mb-4">
 <div class="card-header" style="<?php if($stat=='archived'){ echo 'background:#eeeeee;';}?> ">
  <a href="<?php echo site_url('exam/index/'.$limit.'/table/archived');?>" >  <?php echo $this->lang->line('archived');?>     
 <?php echo $this->lang->line('quiz');?>     
</a>
</div>
<div class="card-body"  >
...
<a href="<?php echo site_url('exam/exam_detail/'.$val['quid']);?>" class="btn btn-success"  ><?php echo $this->lang->line('attempt');?> </a>
...
<a href="<?php echo site_url('exam/edit_exam/'.$val['quid']);?>"><img src="<?php echo base_url('images/edit.png');?>"></a>
<a href="javascript:remove_entry('exam/remove_exam/<?php echo $val['quid'];?>');"><img src="<?php echo base_url('images/cross.png');?>"></a>
<?php 
}
?>
</td>
...
<a href="<?php echo site_url('exam/index/'.$back.'/'.$list_view);?>"  class="btn btn-primary"><?php echo $this->lang->line('back');?></a>
&nbsp;&nbsp;
<?php
 $next=$limit+($this->config->item('number_of_rows'));  ?>

<a href="<?php echo site_url('exam/index/'.$next.'/'.$list_view);?>"  class="btn btn-primary"><?php echo $this->lang->line('next');?></a>
