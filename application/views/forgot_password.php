...
<form method="post" class="form-signin" action="<?php echo site_url('login/forgot');?>">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="email"  placeholder="Email Linked to Account" required="required">
        </div>
        
      <button class="btn btn-lg btn-primary btn-block" type="submit"><?php echo $this->lang->line('send_new_password');?></button>          
    </form>			
    <div class="text-center small">Don't have an account? <a href="<?php echo site_url('login/registration');?>">Sign up</a></div>
</div>
</body>
</html>