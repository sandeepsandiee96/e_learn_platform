...
<form method="post" action="<?php echo site_url('login/insert_user/');?>">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="contact_no" placeholder="Mobile Number" required="required">
        </div>
        
        <input type="submit" class="btn btn-primary btn-block btn-lg" value="Sign Up">              
    </form>			
    <div class="text-center small">Have an account? <a href="<?php echo site_url('login');?>">Login</a></div>
</div>
</body>
</html>