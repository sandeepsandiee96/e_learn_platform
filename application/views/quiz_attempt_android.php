...
function submitform(){
alert('Time Over');
window.location="<?php echo site_url('exam/submit_exam/');?>";
}
...
?>
 ...
 <div class="col-md-8">
<form method="post" action="<?php echo site_url('exam/submit_exam/'.$quiz['rid']);?>" id="quiz_form" >
...
function hidespiner(){
 ...
 function submit_quiz2(){
	...
	setTimeout(function(){
	window.location=base_url+"index.php/api/submit_exam/<?php echo $connection_key;?>/<?php echo $uid;?>/<?php echo $rid;?>";
	},3000);
}
